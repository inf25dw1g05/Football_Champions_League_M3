...
Todos os endpoints estão definidos de acordo com a especificação OpenAPI 3.0, gerada automaticamente pelo LoopBack 4, garantindo uma documentação viva e testável.
