...
export class MatchPlayerController {
  ...
  async find(
    ...
    return this.matchRepository.playersWithEvents(id).find(filter);
  }
  ...
  async create(
    ...
    }) player: Omit<Player, 'player_id'>,
  ): Promise<Player> {
    return this.matchRepository.playersWithEvents(id).create(player);
  }
  ...
  async patch(
    ...
    return this.matchRepository.playersWithEvents(id).patch(player, where);
  }
  ...
  async delete(
    ...
    return this.matchRepository.playersWithEvents(id).delete(where);
  }
}
