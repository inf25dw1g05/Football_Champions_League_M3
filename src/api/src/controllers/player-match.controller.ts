...
export class PlayerMatchController {
  ...
  async find(
    ...
    return this.playerRepository.matchesWithEvents(id).find(filter);
  }
  ...
  async create(
    ...
    return this.playerRepository.matchesWithEvents(id).create(match);
  }
  ...
  async patch(
    ...
    return this.playerRepository.matchesWithEvents(id).patch(match, where);
  }
  ...
  async delete(
    ...
    return this.playerRepository.matchesWithEvents(id).delete(where);
  }
}
