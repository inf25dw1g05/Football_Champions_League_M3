...
export class MatchMatchEventController {
  ...
  async find(
    ...
    return this.matchRepository.matchEvents(id).find(filter);
  }
  ...
  async create(
    ...
    return this.matchRepository.matchEvents(id).create(matchEvent);
  }
  ...
  async patch(
    ...
    return this.matchRepository.matchEvents(id).patch(matchEvent, where);
  }
  ...
  async delete(
    ...
    return this.matchRepository.matchEvents(id).delete(where);
  }
}
